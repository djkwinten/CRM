  ...
  return (
    <div className="bg-gray-100 print:bg-white min-h-screen">
      ...
      <div className="print:hidden bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
        ...
        <span className="flex-1 text-sm text-gray-400">Gig Sheet Preview</span>
      ...
      {/* A4 Print Sheet */}
      <div className="max-w-3xl mx-auto bg-white shadow-lg print:shadow-none my-6 print:my-0 p-8 print:p-6 font-sans">
        {/* Header */}
      ...
      {(() => {
        ...
        return (
          <div className="max-w-3xl mx-auto bg-white shadow-lg print:shadow-none my-6 print:my-0 print:mt-0 p-8 print:p-6 font-sans">
            {/* Header pagina 2 */}
